...
<details>
  <summary><b>4) 깃허브 사용시 어려움 발생</b></summary>

**직면한 문제**  
- 깃허브 사용할때 pr어려움/쓰던 브랜치를 계속 사용해서 충돌도 발생

**해결 과정**  
- comit 후 push하고 pr받고 main브랜치에 올라가면 pull받고 다른 작업을 할땐 브랜치를 이동해서 사용하면서 브랜치간의 충돌 방지
