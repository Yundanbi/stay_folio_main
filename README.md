...
- 숙소 검색 (카테고리, 인원 수, 체크인/체크아웃 날짜 ajax 부분)
- 예약 기능
- 비회원 예약 확인&취소
...
👉 [DB 설계 바로가기](https://spring-team-project2025.github.io/stay_folio_documents/)
<details>
...
- 비회원 취소 처리 로직 구현(예약완료&접속한 날짜가 당일 이전일시 취소버튼 보임)
...
<details>
  <summary><b>1) 결제 실패인데 예약 완료 페이지로 이동하던 버그</b></summary><br>
  
**직면한 문제**
- 결제 실패(결제 응답 코드 실패) 시에도 예약 완료 화면으로 이동하는 문제 발생.
